...
pub fn build_sys_post_route() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route(
            ...
            post(sys_post_handler::delete_sys_post),
        )
        .route(
            "/system/post/updatePost",
            post(sys_post_handler::update_sys_post),
        )
        .route(
            "/system/post/updatePostStatus",
            post(sys_post_handler::update_sys_post_status),
        )
        .route(
            "/system/post/queryPostDetail",
            post(sys_post_handler::query_sys_post_detail),
        )
        .route(
            "/system/post/queryPostList",
