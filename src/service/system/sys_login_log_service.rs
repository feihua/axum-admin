...
impl LoginLogService {
     ...
     */
    pub async fn delete_sys_login_log(state: Arc<AppState>, item: DeleteLoginLogReq) -> impl IntoResponse {
        let rb = &state.batis;
     ...
     *date：2024/12/25 11:36:48
     */
    pub async fn clean_sys_login_log(state: Arc<AppState>) -> impl IntoResponse {
        let rb = &state.batis;
     ...
     *date：2024/12/25 11:36:48
     */
    pub async fn query_sys_login_log_detail(state: Arc<AppState>, item: QueryLoginLogDetailReq) -> impl IntoResponse {
        let rb = &state.batis;
     ...
     *date：2024/12/25 11:36:48
     */
    pub async fn query_sys_login_log_list(state: Arc<AppState>, item: QueryLoginLogListReq) -> impl IntoResponse {
        let rb = &state.batis;
